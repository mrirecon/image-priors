...
if [ ! -f kdat.cfl ] ; then
    ...
    bart ecalib -r 25 -c 0.00001 -m1 kdat_ coils
...
EXPR=/home/gluo/workspace/nlinv_prior/scripts/recon/export_tfl3d.py
total=256
batches=4
batch_size=64
...
export_graph()
{
python $EXPR $total $batches $batch_size $1 $log $meta $path $1
}
